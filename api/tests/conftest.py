...
os.environ.setdefault("SUPERUSER_EMAIL", "admin@urban.com")
os.environ.setdefault("SUPERUSER_PASSWORD", "superuser-test-password")
os.environ.setdefault("SUPERUSER_FULL_NAME", "Administrator")
