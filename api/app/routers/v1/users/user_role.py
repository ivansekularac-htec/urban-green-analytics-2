...
def list_user_roles(
    service: UserRoleServiceDep, current_user: CurrentUserDep, pagination: PaginationDep
):
...
def get_user_role(user_role_id: int, current_user: CurrentUserDep, service: UserRoleServiceDep):
...
def create_user_role(
    payload: UserRoleCreate, service: UserRoleServiceDep, current_user: CurrentUserDep
):
...
def delete_user_role(user_role_id: int, service: UserRoleServiceDep, current_user: CurrentUserDep):
