...
from app.repositories.crops.farm_crop_repository import FarmCropRepository
from app.schemas.crops.farm_crop import FarmCropCreate, FarmCropResponse, FarmCropUpdate
from app.services.crops.farm_crop_service import FarmCropService
...
def list_farm_crops(service: FarmCropServiceDep, skip: int = 0, limit: int = 100):
