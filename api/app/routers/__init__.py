...
from app.routers.v1.farms.growing_system_type import router as _growing_system_type_router
from app.routers.v1.farms.infrastructure_type import router as _infrastructure_type_router
