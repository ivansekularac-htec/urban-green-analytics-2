...
def create_server(client: Client | None = None) -> FastMCP:
    ...
    # FastMCP's tool primitives don't speak Prometheus exposition, only
    # Starlette routes do, so this reads the same global registry that
    # track_tool writes to and renders it the way a scraper expects.
